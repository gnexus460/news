    ...
    <div id="page-bgtop">
      <div id="content">
	        ...
	        <div class="post"> 
	          ...
	          <p class="byline">posted by: <?php echo $newsItem['author_name'].'<br>'.$newsItem['date']; ?></p>
            <hr />
            <img style="max-width: 560px;" src="http://new.septikbronnitsy.ru/views/preview/<?php echo $newsItem['preview'];?>" alt="" />
	          <div class="entry">
